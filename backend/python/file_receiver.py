...
class OptimalRoutingServer(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        r, fn = self.customer_locations()
        # filled with default values 
        params = {
           'origin' : '13.023858,80.163588',
           'routes' : '1',
           'cluster_size' : '4',
        }
        print self.path
        ...
        print r, fn, "by: ", self.client_address
        params['cust_file'] = fn
        f = StringIO()
        f.write('<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">')
        f.write("<html>\n<title>Routing Result Page</title>\n")
        f.write("<body>\n<h2>Result Page</h2>\n")
        f.write("<hr>\n")
        if r:
            cmd_to_execute = PATH + CMD  % params
            print cmd_to_execute 
            os.system(cmd_to_execute)
            with open("/tmp/outrouting.txt") as ofd:
              f.write(ofd.read())
